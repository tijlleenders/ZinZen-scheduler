...
fn test_based_on_i284_7days() {
    ...
    let slots: Vec<Slot> = vec![
        get_slot(duration, year, month, day, start_hour, 0),
        get_slot(duration, year, month, day + 1, start_hour, 0),
        get_slot(duration, year, month, day + 2, start_hour, 0),
        get_slot(duration, year, month, day + 3, start_hour, 0),
        get_slot(duration, year, month, day + 4, start_hour, 0),
        get_slot(duration, year, month, day + 5, start_hour, 0),
        get_slot(duration, year, month, day + 6, start_hour, 0),
        get_slot(duration, year, month, day + 7, start_hour, 0),
        get_slot(duration, year, month, day + 8, start_hour, 0),
        get_slot(duration, year, month, day + 9, start_hour, 0),
        get_slot(duration, year, month, day + 10, start_hour, 0),
    ];
