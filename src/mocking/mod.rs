...
impl Step {
    ...
    pub fn mock_scheduled(
        ...
        Step {
            ...
            status: StepStatus::Scheduled,
            flexibility,
            start_date: Some(step_timing.start),
            end_date: Some(step_timing.end),
            slots: vec![],
            tags: vec![],
            after_goals: None,
        }
...
impl Goal {
    ...
    pub fn mock(id: &str, title: &str, goal_dates: Slot) -> Goal {
        Goal {
            ...
            budgets: None,
            repeat: None,
            start_date: Some(goal_dates.start),
            end_date: Some(goal_dates.end),
            tags: vec![],
            filters: None,
            children: None,
            after_goals: None,
    ...
    mod step {
        ...
        fn test_mock_scheduled() {
            ...
            let expected = Step {
                ...
                status: StepStatus::Scheduled,
                flexibility: 168,
                start_date: Some(expected_step_timing.start),
                end_date: Some(expected_step_timing.end),
                slots: vec![],
                tags: vec![],
                after_goals: None,
            };
