...
mod test_i388 {
    ...
    fn test_i388() {
        let json = r#"{
            ...
            "goals": {
                "1c955b93-729f-4dd9-b334-950fb3731622": {
                    "id": "1c955b93-729f-4dd9-b334-950fb3731622",
                    "title": "Walk 🚶🏽",
                    "filters": {
                        "after_time": 14,
                        "before_time": 20,
                    ...
                    "created_at": "2023-09-15T04:38:57.394Z",
                    "min_duration": 5,
        ...
        let input: crate::models::input::Input = serde_json::from_str(json).unwrap();

        let results = serde_json::to_string(&crate::run_scheduler(input)).unwrap();
        dbg!(results);
    }
}
