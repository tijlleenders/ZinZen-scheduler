...
Budgets can also generate Steps - irrespective of their place in the hierarchy. They are only placed after all 'regular' Steps are placed. Whenever a 'regular' Step belonging to the Budget is placed, these budget Steps get removed for the corresponding time periods and durations.  
